...
# Generated by qmake (2.01a) (Qt 4.6.3) on: Sa. Jul 31 23:37:30 2010
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/naubino21.0.0/ && $(COPY_FILE) --parents Naub.h NaubScene.h NaubView.h .tmp/naubino21.0.0/ && $(COPY_FILE) --parents main.cpp Naub.cpp NaubScene.cpp NaubView.cpp .tmp/naubino21.0.0/ && (cd `dirname .tmp/naubino21.0.0` && $(TAR) naubino21.0.0.tar naubino21.0.0 && $(COMPRESS) naubino21.0.0.tar) && $(MOVE) `dirname .tmp/naubino21.0.0`/naubino21.0.0.tar.gz . && $(DEL_FILE) -r .tmp/naubino21.0.0
